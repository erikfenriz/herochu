...
export default class Happy extends Component {
    ...
    mute = () => {
        if (this.state.strikeThrough === "menu__bottom--natural") {
            this.setState({strikeThrough: "menu__bottom--natural strikethrough"});
        } else {
            this.setState({strikeThrough: "menu__bottom--natural"});
        }
                    ...
                    <div className="menu">
                        ...
                        <div className="menu__bottom">
                            <div onMouseOver={this.hide}
                                ...
                                <p className="menu__bottom--natural">Share</p>
                            </div>
                            <div onMouseOver={this.hide}
                                 onMouseOut={this.display}
