...
import happyMP4 from '../../assets/videos/experience2/mp4/rebellious.mp4';
import happyWebM from "../../assets/videos/experience2/webm/rebelious.webm";
...
export default class Happy extends Component {
    ...
    mute = () => {
        if (this.state.strikeThrough === "menu__bottom--rebellious") {
            this.setState({strikeThrough: "menu__bottom--rebellious strikethrough"});
        } else {
            this.setState({strikeThrough: "menu__bottom--rebellious"});
        }
                    ...
                    <div className="menu">
                        ...
                        <div className="menu__bottom">
                            <div onMouseOver={this.hide}
                                ...
                                <p className="menu__bottom--rebellious">Share</p>
                            </div>
                            <div onMouseOver={this.hide}
                                 onMouseOut={this.display}
