...
import happyMP4 from '../../assets/videos/experience2/mp4/sexy.mp4';
import happyWebM from "../../assets/videos/experience2/webm/sexy.webm";
...
export default class Happy extends Component {
    ...
    mute = () => {
        if (this.state.strikeThrough === "menu__bottom--sexy") {
            this.setState({strikeThrough: "menu__bottom--sexy strikethrough"});
        } else {
            this.setState({strikeThrough: "menu__bottom--sexy"});
        }
